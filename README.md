...
**Learn Danish with Pokémon.** — This is a disassembly of Pokémon Red and Blue, fully translated into **Danish** (99% complete). Play the classic Game Boy games in Danish to practise the language.
